...
//	创建一个定长线程池，可控制线程最大并发数，超出的线程会在队列中等待。示例代码如下：
	 ...
	 */
	public OCRChangeBOX(int type,String ...filePath) {
	...
	public OCRChangeBOX(int type,File filePath) {
...
//			 try {
////				imageDemo.grayImage(mapImag.get(key));
//				imageDemo.binaryImage(mapImag.get(key));
//			} catch (IOException e) {
//				e.printStackTrace();
//			}
